...
class ViewCountSettingsTab extends PluginSettingTab {
  ...
  display(): void {
      ...
      .addDropdown((component) =>
        component
          ...
          .onChange(async (value) => {
            this.plugin.settings.countMethod = value as "unique-days-opened" | "total-times-opened"
    ...
    new Setting(containerEl)
      ...
      .addText((component) =>
        component.setValue(this.plugin.settings.excludedPaths.join(",")).onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.syncToFrontmatter).onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addToggle((component) =>
        component.setValue(this.plugin.settings.skipNewNotes).onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text.setValue(this.plugin.settings.propertyName).onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .setDesc("Time to wait before adding a view count property to a new note.")
      .addDropdown((cb) => {
        cb.addOptions({
          "0": "0",
          "1000": "1000",
        ...
        cb.setValue(this.plugin.settings.templaterDelay.toString()).onChange(async (value) => {
    ...
    new Setting(containerEl)
      .setName("Log level")
      .setDesc("Set the log level. Please use trace to see all log messages.")
      .addDropdown((cb) => {
        cb.addOptions({
          [LOG_LEVEL_OFF]: "Off",
        ...
        cb.setValue(this.plugin.settings.logLevel).onChange(async (value) => {
